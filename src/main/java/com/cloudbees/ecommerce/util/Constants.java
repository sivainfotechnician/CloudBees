...
public class Constants {
	...
	public static final String TITLE_VALIDATION = "Name should not be empty";
	...
	public static final String SELECT_TYPE_MESSAGE ="Please choose between 'Discount' or 'Tax' to proceed with the calculation";
